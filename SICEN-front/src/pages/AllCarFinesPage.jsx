...
export function AllCarFinesPage() {
  ...
  function openStatusEditor(fine) {
    ...
    setStatusEditor({
      ...
      selected: initial,
      plate: formatPlate(fine.car_reg_number),
    });
  }
  ...
  async function saveFineEditor() {
    ...
    if (Number.isNaN(fineAmount) || fineAmount < 0) {
      setFineEditorErr("El importe en U.R. debe ser un número mayor o igual a 0.");
      return;
    }
    const extraAmount =
    ...
    if (!f.car_brand || !f.car_model || !f.car_reg_number) {
      setFineEditorErr(
        "Marca, modelo y matrícula del vehículo son obligatorios."
      );
      return;
    }
    ...
    try {
      ...
      const updated = await carFineUpdateWithProves(
  ...
  async function saveStatusEditor() {
    ...
    try {
      ...
      const updated = await carFineUpdate(statusEditor.fineNumber, {
  ...
  return (
    <Layout>
      <div className="container py-4">
        ...
        <div className="accordion mb-3" id="car-fines-filters-accordion">
          <div className="accordion-item">
            <h2 className="accordion-header">
              <button
                ...
                data-bs-target="#car-fines-filters"
                aria-expanded="false"
                aria-controls="car-fines-filters"
              >
            ...
            <div
              id="car-fines-filters"
              className="accordion-collapse collapse"
              data-bs-parent="#car-fines-filters-accordion"
            >
              <div className="accordion-body">
                <form onSubmit={applyFilters} className="row g-3">
                  <div className="col-12 col-md-6 col-lg-4">
                    <label className="form-label" htmlFor="flt_fine_number">
                      N° de multa
                    </label>
                    <input
                      id="flt_fine_number"
                  ...
                  <div className="col-12 col-md-6 col-lg-4">
                    <label className="form-label" htmlFor="flt_fine_status">
                      Estado
                    </label>
                    <select
                      id="flt_fine_status"
                  ...
                  <div className="col-12 col-md-6 col-lg-4">
                    <label className="form-label" htmlFor="flt_fine_date">
                      Fecha
                    </label>
                    <input
                      id="flt_fine_date"
                  ...
                  <div className="col-12 col-md-6 col-lg-4">
                    <label className="form-label" htmlFor="flt_fine_article">
                      Artículo
                    </label>
                    <select
                      id="flt_fine_article"
                  ...
                  <div className="col-12 col-md-6 col-lg-4">
                    <label className="form-label" htmlFor="flt_fine_amount">
                      Importe (U.R.)
                    </label>
                    <input
                      id="flt_fine_amount"
                  ...
                  <div className="col-12 col-md-6 col-lg-4">
                    <label className="form-label" htmlFor="flt_fine_author">
                      Autor (email)
                    </label>
                    <input
                      id="flt_fine_author"
                  ...
                  <div className="col-12 col-md-6 col-lg-4">
                    <label className="form-label" htmlFor="flt_car_reg_number">
                      Matrícula
                    </label>
                    <input
                      id="flt_car_reg_number"
                      type="text"
                      className="form-control text-uppercase"
                      value={filters.car_reg_number}
                      onChange={(e) =>
                        setFilter(
                          "car_reg_number",
                  ...
                  <div className="col-12 col-md-6 col-lg-4">
                    <label className="form-label" htmlFor="flt_car_brand">
                      Marca
                    </label>
                    <input
                      id="flt_car_brand"
                      ...
                      onChange={(e) =>
                        setFilter("car_brand", e.target.value)
                      }
                    />
                  </div>
                  <div className="col-12 col-md-6 col-lg-4">
                    <label className="form-label" htmlFor="flt_car_model">
                      Modelo
                    </label>
                    <input
                      id="flt_car_model"
                      ...
                      onChange={(e) =>
                        setFilter("car_model", e.target.value.toUpperCase())
                      }
                      style={{ textTransform: "uppercase" }}
                    />
                  </div>
                  <div className="col-12 col-md-6 col-lg-4">
                    <label className="form-label" htmlFor="flt_owner_ci">
                      DNI del titular
                    </label>
                    <input
                      id="flt_owner_ci"
                  ...
                  <div className="col-12 col-md-6 col-lg-4">
                    <label className="form-label" htmlFor="flt_owner_name">
                      Nombre del titular
                    </label>
                    <input
                      id="flt_owner_name"
            ...
            <div className="card-body">
              ...
              >
                ...
                <div className="col-12 col-md-4">
                  <label
                    className="form-label"
                    htmlFor="edit_fine_article"
                  >
                    Artículo*
                  </label>
                  <select
                    id="edit_fine_article"
                    className="form-select"
                    required
                ...
                <div className="col-12 col-md-6">
                  <label
                    className="form-label"
                    htmlFor="edit_fine_extra_amount"
                  >
                    Cantidad extra U.R.
                  </label>
                  <input
                    id="edit_fine_extra_amount"
                    type="number"
                    className="form-control"
                    min={0}
                    step="any"
                ...
                <div className="col-12 col-md-4">
                  <label
                    className="form-label"
                    htmlFor="edit_car_brand"
                  >
                    Marca*
                  </label>
                  <CarBrandCombobox
                    id="edit_car_brand"
                    value={fineEditor.form.car_brand}
                    onChange={(v) => setFineEditorField("car_brand", v)}
                    required
                  />
                  {fineEditor.form.car_brand === OTHER_CAR_BRAND ? (
                ...
                <div className="col-12 col-md-4">
                  ...
                  <input
                    ...
                    className="form-control text-uppercase"
                    required
                    value={fineEditor.form.car_model}
                    onChange={(e) =>
                      setFineEditorField(
                        "car_model",
                ...
                <div className="col-12 col-md-4">
                  <label
                    className="form-label"
                    htmlFor="edit_car_reg_number"
                  >
                    Matrícula*
                  </label>
                  <input
                    id="edit_car_reg_number"
                    className="form-control text-uppercase"
                    required
                    inputMode="text"
                    autoComplete="off"
                    spellCheck={false}
                    value={fineEditor.form.car_reg_number}
                    onChange={(e) =>
                      setFineEditorField(
                        "car_reg_number",
                        e.target.value.replace(/\s+/g, "").toUpperCase()
                  ...
                  <div className="border rounded p-3 car-fine-editor-proves">
                    ...
                    <div className="row g-3">
                      {PROVE_SLOT_INDICES.map((idx) => {
                        ...
                        if (!slot) return null;
                        const inputId = `edit_prove_slot_${idx + 1}`;
                        const previewSrc =
                          slot.previewUrl ||
