...
function StatsTable({ rows, total, emptyLabel, valueLabel, formatLabel }) {
          ...
          {rows.map((row, idx) => {
            ...
            return (
              <tr key={`${row.label}-${idx}`}>
                ...
                <td className="text-break">{displayLabel}</td>
...
function formatPlateLabel(value) {
  ...
  if (value === "Sin matrícula") return value;
  return formatPlate(value) || value;
}
...
export function CarFinesMenuPage() {
  ...
  const loadStats = useCallback(async () => {
    ...
    setStatsErr("");
    try {
      const res = await carFinesStats({ limit: 10 });
  ...
  const topPlates = stats?.topPlates ?? [];
      ...
      <div className="container py-4">
        ...
        <div className="row row-cols-1 row-cols-md-3 g-3">
                  ...
                  <div className="d-flex align-items-start gap-2">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-muted small">
                        Registrar una nueva multa vehicular.
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="col">
            <Link className="text-decoration-none" to="/multas/vehiculos/todas">
              <div className="card h-100 shadow-sm">
                <img
                  src="/img/readCarFine.jpg"
                  alt="Consultar y modificar multas"
                  className="card-img-top"
                  loading="lazy"
                />
                <div className="card-body">
                  <div className="d-flex align-items-start gap-2">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-muted small">
                        Buscar multa y modificar sus datos y estado.
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="mt-4">
          <div className="d-flex align-items-end justify-content-between flex-wrap gap-2 mb-2">
            <div>
              <h4 className="m-0">Estadísticas de multas vehiculares</h4>
              <div className="text-muted small">
              ...
              <div className="row g-4">
                <div className="col-12 col-lg-4">
                  <h6 className="text-uppercase text-muted small fw-semibold border-bottom pb-2 mb-3">
                    <i className="bi bi-car-front-fill me-2" aria-hidden />
                    Matrículas más infractoras
                  </h6>
                  {statsLoading && !stats ? (
                    ...
                    <StatsTable
                      rows={topPlates}
                      total={total}
                      valueLabel="Matrícula"
                      formatLabel={formatPlateLabel}
                      emptyLabel="Aún no hay multas registradas con matrícula."
                    />
                  )}
                </div>
